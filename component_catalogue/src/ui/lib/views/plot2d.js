  ...
  define(['backbone'], function(Backbone) {
    return Backbone.View.extend({
      ...
      adjustCanvasToPoints: function(points) {
        var rawPoints, x, xMax, xMin, y, yMax, yMin, _ref, _ref2;
        ...
        _ref2 = [_.min(y), _.max(y)], yMin = _ref2[0], yMax = _ref2[1];
      ...
      renderPoints: function(points) {
        ...
        for (key in points) {
          ...
          _results.push((function() {
            var _i, _len, _ref, _ref2, _results2;
            _results2 = [];
            for (_i = 0, _len = data.length; _i < _len; _i++) {
              point = data[_i];
              _ref = point.slice(1, 4), x = _ref[0], y = _ref[1], phi = _ref[2];
              _ref2 = [this.normalizedX(x), this.normalizedY(y)], nx = _ref2[0], ny = _ref2[1];
              _results2.push(this.drawCircleWithOrientationInRad(nx, ny, phi, color));
            }
            return _results2;
          }).call(this));
        }
